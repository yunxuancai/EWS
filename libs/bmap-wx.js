...
class BMapWX {
    ...
    search(param) {
        ...
        let searchparam = {
            ...
            location: param["location"] || "39.915,116.404"
        };
        let otherparam = {
                    ...
                    if (res["status"] === 0) {
                        ...
                        for (let i = 0; i < poiArr.length; i++) {
                            outputRes["wxMarkerData"][i] = {
                                ...
                                price: poiArr[i]["detail_info"]["price"] + "￥",
    ...
    suggestion(param) {
        ...
        let suggestionparam = {
            ...
            ret_coordtype: 'gcj02ll',
            location: {
                latitude: param["latitude"] || '23.131030797954',
                longitude: param["longitude"] || '113.26308929823'
            }
        };
        let otherparam = {
            success: param["success"] || function () {},
